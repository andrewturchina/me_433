...
//
//            }
            //code to send the value of a variable to the computer at 1Hz, incrementing the value each time, and also invert an LED so you know it is sending somethings
